...
- **Questions from Claude Code now wait for your answer instead of being auto-cancelled** — when the coding agent asked a clarifying question, the question appeared in the chat but the agent did not pause for your answer. By the time you tapped Submit, the agent had already given up and moved on as if you had refused to answer. The agent now blocks on the question until you submit a response (or up to one hour), and your answer is delivered back to the agent so it can continue with the right context (Backend)
