...
if sys.platform == 'win32':
    hiddenimports += ['src.gui', 'src.gui_core', 'src.theme', 'pystray', 'pystray._win32', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'winpty', 'customtkinter']
elif sys.platform == 'darwin':
    hiddenimports += ['src.gui_macos', 'src.gui_core', 'src.theme', 'AppKit', 'Foundation', 'objc', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'customtkinter']
